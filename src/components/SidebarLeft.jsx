...
export default function SidebarLeft() {
  ...
  return (
    <aside className={`bg-white border-r shadow-sm h-full flex flex-col transition-all duration-300 ${collapsed ? 'w-16' : 'w-56'}`}>
          ...
          <div className="mt-4 flex-1 overflow-y-auto px-3 pb-4 space-y-4 text-sm">
            {activeTab === 'Elements' && (
              <div className="space-y-2">
                ...
                <button onClick={addRect} className="w-full flex items-center gap-2 px-3 py-2 rounded border border-dashed hover:bg-gray-50">
            ...
            {activeTab === 'Images' && (
              <div className="space-y-2">
                ...
                <button onClick={()=>fileRef.current?.click()} className="w-full flex items-center gap-2 px-3 py-2 rounded border hover:bg-gray-50">
